...
public class BlockCutoffSwitch3 extends Block implements ITileEntityProvider {
     ...
     * Stored in metadata bit 2. Kept in sync with TileEntityCutoffSwitch3#active
    ...
    public BlockCutoffSwitch3() {
        super(Material.IRON);
        setRegistryName(RealGrid.MODID, "maclean_cutoff_switch_closed_3");
         ...
         */
        setTranslationKey(RealGrid.MODID + ".maclean_cutoff_switch_closed_3");
    ...
    /** Casts the TE at pos to TileEntityCutoffSwitch3, or returns null. */
    @Nullable
    private TileEntityCutoffSwitch3 getSwitchTE(IBlockAccess world, BlockPos pos) {
        TileEntity te = world.getTileEntity(pos);
        return te instanceof TileEntityCutoffSwitch3 ? (TileEntityCutoffSwitch3) te : null;
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        TileEntityCutoffSwitch3 te = getSwitchTE(world, pos);
     ...
     *    Delegates to TileEntityCutoffSwitch3#hammerUseSide which toggles the
    ...
    /**
     * TileEntityCutoffSwitch3#update() polls isRedstonePowered() every tick and
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos,
        ...
        // Intentionally empty — handled by TileEntityCutoffSwitch3.update()
    }
     ...
     * TileEntityCutoffSwitch3#receiveClientEvent updates te.active and calls
