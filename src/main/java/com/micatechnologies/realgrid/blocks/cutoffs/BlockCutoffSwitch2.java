...
public class BlockCutoffSwitch2 extends Block implements ITileEntityProvider {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch2) {
            return state.withProperty(ACTIVE, ((TileEntityCutoffSwitch2) te).active);
        }
        return state;
    }
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state,
        ...
        if (!world.isRemote) {
            TileEntity te = world.getTileEntity(pos);
            if (te instanceof TileEntityCutoffSwitch2) {
                ((TileEntityCutoffSwitch2) te).facing = state.getValue(FACING);
            }
        }
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (!(te instanceof TileEntityCutoffSwitch2)) return false;

        TileEntityCutoffSwitch2 switchTe = (TileEntityCutoffSwitch2) te;
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos,
        ...
        // Intentionally empty: state changes are driven by TileEntityCutoffSwitch2.update()
    }
    ...
    public int getWeakPower(IBlockState state, IBlockAccess world,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch2)
            return ((TileEntityCutoffSwitch2) te).getWeakRSOutput(state, side);
        return 0;
    }
    ...
    public int getStrongPower(IBlockState state, IBlockAccess world,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch2)
            return ((TileEntityCutoffSwitch2) te).getStrongRSOutput(state, side);
        return 0;
    }
