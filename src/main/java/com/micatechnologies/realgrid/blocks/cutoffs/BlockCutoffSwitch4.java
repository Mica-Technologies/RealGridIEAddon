 ...
 */
public class BlockCutoffSwitch4 extends Block implements ITileEntityProvider {
     ...
     * Stored in metadata bit 2. Kept in sync with TileEntityCutoffSwitch4#active
    ...
    public BlockCutoffSwitch4() {
        super(Material.IRON);
        setRegistryName(RealGrid.MODID, "maclean_cutoff_switch_closed_4");
         ...
         */
        setTranslationKey(RealGrid.MODID + ".maclean_cutoff_switch_closed_4");
    ...
    /** Casts the TE at pos to TileEntityCutoffSwitch4, or returns null. */
    @Nullable
    private TileEntityCutoffSwitch4 getSwitchTE(IBlockAccess world, BlockPos pos) {
        TileEntity te = world.getTileEntity(pos);
        return te instanceof TileEntityCutoffSwitch4 ? (TileEntityCutoffSwitch4) te : null;
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        TileEntityCutoffSwitch4 te = getSwitchTE(world, pos);
     ...
     *    Delegates to TileEntityCutoffSwitch4#hammerUseSide which toggles the
    ...
    /**
     * TileEntityCutoffSwitch4#update() polls isRedstonePowered() every tick and
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos,
        ...
        // Intentionally empty — handled by TileEntityCutoffSwitch4.update()
    }
     ...
     * TileEntityCutoffSwitch4#receiveClientEvent updates te.active and calls
