...
public class BlockCutoffSwitch4 extends Block implements ITileEntityProvider {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch4) {
            return state.withProperty(ACTIVE, ((TileEntityCutoffSwitch4) te).active);
        }
        return state;
    }
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state,
        ...
        if (!world.isRemote) {
            TileEntity te = world.getTileEntity(pos);
            if (te instanceof TileEntityCutoffSwitch4) {
                ((TileEntityCutoffSwitch4) te).facing = state.getValue(FACING);
            }
        }
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (!(te instanceof TileEntityCutoffSwitch4)) return false;

        TileEntityCutoffSwitch4 switchTe = (TileEntityCutoffSwitch4) te;
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos,
        ...
        // Intentionally empty: state changes are driven by TileEntityCutoffSwitch4.update()
    }
    ...
    public int getWeakPower(IBlockState state, IBlockAccess world,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch4)
            return ((TileEntityCutoffSwitch4) te).getWeakRSOutput(state, side);
        return 0;
    }
    ...
    public int getStrongPower(IBlockState state, IBlockAccess world,
        ...
        TileEntity te = world.getTileEntity(pos);
        if (te instanceof TileEntityCutoffSwitch4)
            return ((TileEntityCutoffSwitch4) te).getStrongRSOutput(state, side);
        return 0;
    }
