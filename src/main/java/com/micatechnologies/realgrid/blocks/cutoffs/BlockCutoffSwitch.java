...
/**
 * Cutoff Switch Block
 * A single block. Has FACING and ACTIVE properties.
...
public class BlockCutoffSwitch extends Block implements ITileEntityProvider
{
    ...
    {
        super(Material.IRON);
        setRegistryName(RealGrid.MODID, "cutoff_switch");
        setTranslationKey(RealGrid.MODID + ".cutoff_switch");
        setHardness(3.0f);
        setResistance(15.0f);
                                ...
                                EntityLivingBase placer, ItemStack stack)
    {
        if (!world.isRemote)
        {
            ...
            if (te instanceof TileEntityCutoffSwitch)
            {
                ((TileEntityCutoffSwitch) te).facing = facing;
            }
        }
    }
