...
public class BlockCutoffSwitch extends Block implements ITileEntityProvider {
     ...
     * Stored in metadata bit 2. Kept in sync with TileEntityCutoffSwitch#active
    ...
    public BlockCutoffSwitch() {
        super(Material.IRON);
        setRegistryName(RealGrid.MODID, "maclean_cutoff_switch_closed");
         ...
         */
        setTranslationKey(RealGrid.MODID + ".maclean_cutoff_switch_closed");
    ...
    /** Casts the TE at pos to TileEntityCutoffSwitch, or returns null. */
    @Nullable
     ...
     *    Delegates to TileEntityCutoffSwitch#hammerUseSide which toggles the
    ...
    /**
     * TileEntityCutoffSwitch#update() polls isRedstonePowered() every tick and
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos,
        ...
        // Intentionally empty — handled by TileEntityCutoffSwitch.update()
    }
     ...
     * TileEntityCutoffSwitch#receiveClientEvent updates te.active and calls
