...
// NO CHANGES: This file is correct as-is. GameRegistry.registerTileEntity() is
// the proper Forge 1.12 API for tile entity registration and does not interact
// with the block registry event system, so it does not contribute to the
// double-registration issue found in ModBlocks.java.
